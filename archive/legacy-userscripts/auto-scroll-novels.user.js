// ==UserScript==
// @name         Auto Scroll Novels
// @namespace    local.auto-scroll-novel-reader
// @version      1.1.0
// @description  Ajoute un auto-scroll lent, déplaçable et réglable pour la lecture de romans en ligne.
// @include      /^https?:\/\/.*(novel|webnovel|lightnovel|light-novel|fiction|wuxia|royalroad|scribblehub).*$/
// @noframes
// @grant        GM_getValue
// @grant        GM_setValue
...
(() => {
  ...
  const SPEED_STORAGE_KEY = "autoScrollNovelSpeedPxPerSecond";
  const POSITION_STORAGE_KEY = "autoScrollNovelButtonPosition";
